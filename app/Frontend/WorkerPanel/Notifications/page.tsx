...
import WNavbar from '@/app/Frontend/Components/WNavbar';
import WDownbar from '@/app/Frontend/Components/WDownbar';

interface Notification {
  id: string;
  title: string;
  message: string;
  type: 'new_survey' | 'ending_soon' | 'expired';
  is_read: boolean;
  created_at: string;
  related_id?: string;
}
    ...
    <div className="flex flex-col min-h-screen bg-[var(--OffWhite)] pb-24">
      ...
      <main className="flex-1 px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-[var(--font-poppins)] font-semibold text-gray-800">Notifications</h1>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-xs text-gray-400 mt-1">We'll notify you when new surveys arrive!</p>
          </div>
        ) : (
            ...
            {notifications.map((notif) => (
              <div 
                ...
                onClick={() => {
                  ...
                  if (notif.related_id) router.push(`/Frontend/WorkerPanel/Forms/Attend?id=${notif.related_id}`);
                }}
              ...
              >
                ...
                <div className="flex gap-4">
                  <div className={`flex items-center justify-center h-10 w-10 rounded-xl shrink-0 ${
                    notif.type === 'new_survey' ? 'bg-blue-50' : 
                    notif.type === 'ending_soon' ? 'bg-orange-50' : 'bg-red-50'
                  }`}>
